...
public class WalletServicesUnitTests {
	...
	@Test
	public void getBalanceUnitTest() {
		walletDto = new WalletDto();
		walletDto.setId(1);
		System.out.println(walletService.getBalance(walletDto));
	}
	
	@Test
	public void addWalletUnitTests() {
		walletDto = new WalletDto();
		walletDto.setAmount(58000.0);
		walletDto.setOwner_id(3);
		walletDto.setCreated_by_id(1);
		ObjectResponse<Wallet> response = walletService.addWallet(walletDto);
		System.out.println(response.getResponseMessage() + " - " + response.getDto());
	}
	
	@Test
	public void debitUnitTests() {
		walletDto = new WalletDto();
		walletDto.setId(2);
		walletDto.setAmount(400.0);
		walletDto.setOwner_id(1);
		ObjectResponse<Wallet> response = walletService.debit(walletDto);
		System.out.println(response);
	}
	
	@Test
	public void creditUnitTests() {
		walletDto = new WalletDto();
		walletDto.setId(1);
	...
	@Test
	public void getAllWalletsUnitTests() {
		ListResponse<Wallet> response = walletService.getAllWallets();
